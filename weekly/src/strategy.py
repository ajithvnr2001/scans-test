...
DAMAGE_LOOKBACK = 45
RECENT_LOOKBACK = 8
CONTRACTION_MID_LOOKBACK = 14
CONTRACTION_SHORT_LOOKBACK = 6
VERTICAL_LOOKBACK = 26
NEAR_PIVOT_PCT = 0.03
BREAKOUT_SCAN_BARS = 8
FOLLOW_THROUGH_MAX_BARS = 6
FAST_FOLLOW_THROUGH_BARS = 4
MAX_RECENT_RANGE = 0.16
DAMAGED_DRAWDOWN = 0.33
DAMAGED_RANGE = 0.45
EARLY_MAX_BELOW_PIVOT = 0.02
EARLY_MAX_RECENT_RANGE = 0.10
...
def analyze_five_star_setup(candles: list[Candle]) -> SetupSignal:
    ...
    if early_entry:
        stage = "early_entry"
        reasons.append("strict weekly early-entry candidate near pivot")
